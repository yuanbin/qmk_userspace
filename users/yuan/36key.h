...
#define __BASE_LT__ LT(L_NAV, KC_BSPC), LT(L_SYMR, KC_ENTER)
...
#define __BASE_RT__ LT(L_SYML, KC_SPACE), LT(L_NUM, KC_TAB)
...
#define __SYML_LT__ KC_DEL,            KC_ESC
...
#define __FNMOUSE_LT__ DM_PLY1, DM_PLY2
...
#define __FNMOUSE_RT__ __EMPTY2__
...
#define __AUTOMOUSE_LT__ TO(L_BASE),     KC_NO
...
#define __AUTOMOUSE_RT__ KC_NO,          KC_NO
